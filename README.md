...
学生時代にはDirectX等を用いてゲームエンジンを自作し、3Dモデリングやモーション作成等も自分で行ってゲームを開発していました。  
...
#### ◆ Unity WebGLでのRPG開発の技術監修

2023/01 - 現在  
開発中につき詳細は控えさせていただきます。  

#### ◆ Unity WebGLでのソーシャルゲーム開発
