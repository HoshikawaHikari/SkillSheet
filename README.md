...
|規模|チーム18名～|
|使用言語|C#|
|担当|クライアントサイドリードエンジニア<br> Unity関係のほぼ全て(NFT周りを除く)<br> CD/CI調整|
...
|担当|UI関係の実装全般<br> エンディングムービーシーンの実装等|
...
|担当|リードエンジニア<br> 企画以外の開発全般<br> Slackの自動翻訳ツール開発|
...
|担当|リードエンジニア<br> クライアントサイド<br> UI実装<br> AR機能実装<br> 課金処理実装|
|備考||
...
|担当|リードエンジニア<br> 企画以外の開発全般<br> モック作成からアルファ版の開発まで<br> Unityにおけるルート探索AIのノウハウ研究|
